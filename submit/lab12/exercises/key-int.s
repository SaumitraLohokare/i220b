...
getchar:
		...
		mov     %al, inChar     #mov char read to inChar
	        xor	%al, %al
		mov	%al, hasKey     #reset hasKey flag; ANS: AL was empty, then hasKey would become 0, otherwise it would become 1. Hence we need to set hasKey after we have taken a char input.
		pop	%ax
		ret
